        ...
        @endif 
         ...
         <form  action ="{{url('uploadproduct')}}" method="post" enctype="multipart/form-data">
          ...
          <div style="padding: 15px">          
             ...
             <input style = "color:black;" type="text" name="title" placeholder="give the product title" required=""> 
          </div>

        <div style="padding: 15px">          
          <label>Product price </label> 
          <input style = "color:black;" type="text" name="price" placeholder="product price" required=""> 
        </div> 
