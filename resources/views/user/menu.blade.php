            ...
            <nav class="navbar navbar-expand-lg">
                <div class="container">
                    <a class="navbar-brand" href="index.html"
                        ><h2>Online Food<em> Order </em></h2></a
                    >
                    <button
                    ...
                    <div class="col-md-12">
                        <div class="filters">
                            <ul>
                                ...
                                <li data-filter=".des">BreakFast</li>
                                <li data-filter=".dev">Lunch</li>
                                <li data-filter=".gra">Dinner</li>
                            </ul>
                        </div>
                    </div>
                    <!-- <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="inner-content">
                            <p>
                                Copyright &copy; 2022 online food order system.
                                <a
